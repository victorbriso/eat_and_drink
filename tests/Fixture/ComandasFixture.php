 ...
 * ComandasFixture
 */
class ComandasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'clientes' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        'modified' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        '_indexes' => [
            'com_local_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'com_salon_idx' => ['type' => 'index', 'columns' => ['salon_id'], 'length' => []],
            'com_mesa_idx' => ['type' => 'index', 'columns' => ['table_id'], 'length' => []],
            'com_garzon_idx' => ['type' => 'index', 'columns' => ['usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'com_mesa' => ['type' => 'foreign', 'columns' => ['table_id'], 'references' => ['tables', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'com_local' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'com_garzon' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'com_salon' => ['type' => 'foreign', 'columns' => ['salon_id'], 'references' => ['salons', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
