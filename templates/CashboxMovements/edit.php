...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $cashboxMovement->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $cashboxMovement->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="cashboxMovements form content">
            ...
            <fieldset>
                <legend><?= __('Edit Cashbox Movement') ?></legend>
                <?php
