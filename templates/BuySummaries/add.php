...
<?= $this->Html->scriptBlock(sprintf("var bodegas                   = %s;", json_encode($bodegas))); ?>
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tr>
                    <td>
                        <select name="proveedor" class="form-control select" data-live-search="true" id="listaProveedores">
                            <option disabled selected>--Seleccione</option>
                            <? foreach ($proveedores as $key => $value) {?>
                                <option value="<?=$value['id']?>" nombre="<?=$value['nombre']?>"><?=$value['nombre']?></option>
                            <?} ?>
                        </select>
                    </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            if(codigo.length>0){
                ...
                if (producto.length!='undefined'){
                    ...
                    var trAgregado = '<tr id=producto'+iteral+'>'+
                        ...
                        '<td>$'+bruto+'</td>'+
                        '<td><select class="form-control select" name="data['+iteral+'][bodega]" id="selectBodega'+iteral+'"></select></td>'+
                    ...
                    $.each(bodegas, function( index, value ) {
                        var nombreBodega=value['nombre'];
                        var idBodega=value['id'];
                        optionBodega = '<option value="'+idBodega+'">'+nombreBodega+'</option>';
                        $('#selectBodega'+iteral).append(optionBodega);
                    });
                    iteral++;
                }else{
        ...
        $('.continuar').on('click', function(){
            var proveedor=$('option:selected', '#listaProveedores').attr('nombre');
